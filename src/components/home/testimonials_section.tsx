        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          {testimonials.slice(0, 6).map((testimonial, index) => (
            ...
            >
              ...
              {/* Comment */}
              <p className="text-zinc-700 text-sm sm:text-base leading-relaxed mb-4 sm:mb-6 relative z-10">
              ...
              {/* Result Image */}
              {testimonial.image && (
                <div className="mt-3 sm:mt-4 relative h-40 sm:h-48 rounded-lg sm:rounded-xl overflow-hidden">
                  <Image
        ...
        >
          <div className="flex items-center justify-center gap-1.5 sm:gap-2 mb-3 sm:mb-4">
            {[...Array(5)].map((_, i) => (
              <Star
                key={i}
                className="h-6 w-6 sm:h-8 sm:w-8 text-white fill-white"
              />
            ))}
          </div>
